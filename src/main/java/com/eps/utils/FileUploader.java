...
public class FileUploader {
	...
	public static enum Result
	{
		...
		SUCCESS("成功"),
		/** 失败：文件总大小超过限制 */
		SIZE_EXCEEDED("文件总大小超过限制"),
		/** 失败：单个文件大小超过限制 */
		FILE_SIZE_EXCEEDED("单个文件大小超过限制"),
		/** 失败：请求表单类型不正确 */
		INVALID_CONTENT_TYPE("请求表单类型不正确"),
		/** 失败：文件上传 IO 错误 */
		FILE_UPLOAD_IO_EXCEPTION("文件上传 IO 错误"),
		/** 失败：解析上传请求其他异常 */
		OTHER_PARSE_REQUEST_EXCEPTION("解析上传请求其他异常"),
		/** 失败：文件类型不正确 */
		INVALID_FILE_TYPE("文件类型不正确"),
		/** 失败：文件写入失败 */
		WRITE_FILE_FAIL("文件写入失败"),
		/** 失败：文件保存路径不正确 */
		INVALID_SAVE_PATH("文件保存路径不正确");
